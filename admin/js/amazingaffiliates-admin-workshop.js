...
function product_display(mode = 'warehouse') {
	...
	var asin = '';
	asin = warehouse_asin_selector.val();
	var title = '';
	title = warehouse_title_selector.val();
	var entries = '';
	entries = warehouse_entries_selector.val();
...
jQuery(document).ready( function() {
	...
	jQuery("#asin_purifier").on( 'keyup mouseup change paste input propertychange tap', function(e) { product_link_purify(e); } );
